...
| `signal-flow/` | Compatibility path for signal-flow diagrams using hyphen naming. |
| `state-machines/` | Boot, recovery, OTA, telemetry, and fault state machines. |
| `state-machines/` | Compatibility path for state-machine diagrams using hyphen naming. |
