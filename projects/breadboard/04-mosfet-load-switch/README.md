...
**Beginner · 100 minutes · ESP32-DEVKITC-32E · 3.3 V**
...
Interface: **GPIO**. Prerequisite: **03-button-input**.

Evidence status: **Hardware evidence required**.

## Breadboard connection map

![MOSFET Low-Side Load Switch breadboard connection map](../../../assets/projects/04-mosfet-load-switch/breadboard.svg)
...
![MOSFET Low-Side Load Switch electrical schematic](../../../assets/projects/04-mosfet-load-switch/schematic.svg)
