...
| required / verified | Alpha & Omega Semiconductor `AO3400A` | SOT-23 on pin-labelled 2.54 mm adapter | 3.3 V gate drive; project load is <=10 mA | AO3400A genuine SOT23 breakout adapter India | Do not substitute IRF520, IRLZ44N or an untraceable module. | [source](https://www.aosmd.com/res/data_sheets/AO3400A.pdf) |
