...
| required / suggested | documented manufacturer `6x6 mm, four-lead breadboard type` | through-hole | 3.3 V logic | 6x6 tactile switch breadboard India | Map internally common pin pairs with continuity mode. | learner must verify |
