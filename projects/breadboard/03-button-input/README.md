...
**Beginner · 90 minutes · ESP32-DEVKITC-32E · 3.3 V**
...
Interface: **GPIO**. Prerequisite: **02-led-current**.

Evidence status: **Hardware evidence required**.

## Breadboard connection map

![Button Input: Floating, Pulled and Debounced breadboard connection map](../../../assets/projects/03-button-input/breadboard.svg)
...
![Button Input: Floating, Pulled and Debounced electrical schematic](../../../assets/projects/03-button-input/schematic.svg)
