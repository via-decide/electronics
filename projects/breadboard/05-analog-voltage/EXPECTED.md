...
Raw code should move monotonically with wiper voltage. Agreement with a DMM is UNKNOWN until calibrated and measured.

- **Serial/output pattern:** `adc_raw_mean=... calibrated_mv=... calibrated=<0|1> dmm_mv=RECORD`.
...
- **State transition:** A table contains DMM voltage, raw mean, calibrated voltage, error and measurement conditions.
