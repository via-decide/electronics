# Electricity You Can Measure

## 1. Physical problem this lesson solves

This lesson solves how to **make voltage, resistance and continuity observable**.
...
DMM, leads, resistor and unpowered breadboard. Power policy: 3.3 V only; power off before rewiring.

## 4. What you will build

The physical circuit in [Project 01](../../projects/breadboard/01-know-your-breadboard/PROJECT.md).
...
[Project 01](../../projects/breadboard/01-know-your-breadboard/PROJECT.md)

## 11. Success condition

predict the meter mode before touching a node. Save evidence using the linked project template.

## 12. Next lesson

[Breadboard Without Confusion](02-breadboard-without-confusion.md)
