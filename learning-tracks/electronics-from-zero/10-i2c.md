...
This lesson solves how to **address a register device on open-drain shared lines**.
...
TMP117 breakout. Power policy: 3.3 V only; power off before rewiring.

## 4. What you will build

The physical circuit in [Project 07](../../projects/buses/07-i2c-sensor/PROJECT.md).
...
[Project 07](../../projects/buses/07-i2c-sensor/PROJECT.md)

## 11. Success condition

show address, ACK/NACK, register pointer and data. Save evidence using the linked project template.
...
- Espressif, [ESP-IDF I2C Driver](https://docs.espressif.com/projects/esp-idf/en/stable/esp32/api-reference/peripherals/i2c.html) (retrieved 2026-07-25).
- NXP, [UM10204 I2C-bus Specification and User Manual](https://www.nxp.com/documents/user_manual/UM10204.pdf) (retrieved 2026-07-25).
- Texas Instruments, [TMP117 Datasheet](https://www.ti.com/lit/gpn/TMP117) (retrieved 2026-07-25).
