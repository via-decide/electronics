...
This lesson solves how to **turn a bounded analog voltage into evidence**.
...
10 kohm potentiometer and ADC1 pin. Power policy: 3.3 V only; power off before rewiring.

## 4. What you will build

The physical circuit in [Project 05](../../projects/breadboard/05-analog-voltage/PROJECT.md).
...
[Project 05](../../projects/breadboard/05-analog-voltage/PROJECT.md)

## 11. Success condition

compare calibrated ADC voltage with a DMM. Save evidence using the linked project template.

## 12. Next lesson

[Capacitor and Time](07-capacitor-and-time.md)
