...
This lesson solves how to **coordinate mapping, integrity, recovery and media state**.
...
existing simulator, FTL and future FPGA. Power policy: 3.3 V only; power off before rewiring.
...
explain how evidence closes each controller invariant. Save evidence using the linked project template.

## 12. Next lesson

[Existing SSD lab](../../projects/ssd_lab/README.md)
