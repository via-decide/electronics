...
This lesson solves how to **detect changed bytes before accepting an object**.
...
Project 10 firmware and host test. Power policy: 3.3 V only; power off before rewiring.
...
cause a controlled bit change in simulation and reject it. Save evidence using the linked project template.

## 12. Next lesson

[Power-Loss-Safe Write](15-power-loss-safe-write.md)
