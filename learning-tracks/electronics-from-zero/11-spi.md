...
This lesson solves how to **control when synchronous bits move and which device answers**.
...
SN74HC595N and logic analyzer. Power policy: 3.3 V only; power off before rewiring.

## 4. What you will build

The physical circuit in [Project 08](../../projects/buses/08-spi-shift-register/PROJECT.md).
...
[Project 08](../../projects/buses/08-spi-shift-register/PROJECT.md)

## 11. Success condition

trace clock, data and latch/selection separately. Save evidence using the linked project template.

## 12. Next lesson

[External EEPROM](12-external-eeprom.md)
...
- Texas Instruments, [SN74HC595 Datasheet](https://www.ti.com/lit/ds/symlink/sn74hc595.pdf) (retrieved 2026-07-25).
