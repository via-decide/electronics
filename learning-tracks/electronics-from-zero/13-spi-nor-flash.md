...
This lesson solves how to **work with program pages and erase sectors**.
...
MX25L3233FM2I-08G on adapter. Power policy: 3.3 V only; power off before rewiring.
...
identify, erase a reserved sector, program and verify. Save evidence using the linked project template.

## 12. Next lesson

[CRC and Corruption](14-crc-and-corruption.md)
