...
This lesson solves how to **frame asynchronous bytes into validated messages**.
...
GPIO17/GPIO16 loopback wire. Power policy: 3.3 V only; power off before rewiring.

## 4. What you will build

The physical circuit in [Project 06](../../projects/buses/06-uart-conversation/PROJECT.md).
...
[Project 06](../../projects/buses/06-uart-conversation/PROJECT.md)

## 11. Success condition

reject a bad magic, length or CRC. Save evidence using the linked project template.
...
- Espressif, [ESP-IDF UART Driver](https://docs.espressif.com/projects/esp-idf/en/stable/esp32/api-reference/peripherals/uart.html) (retrieved 2026-07-25).
