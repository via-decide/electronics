...
This lesson solves how to **manage bad blocks, spare area and ECC instead of treating NAND as NOR**.
...
existing W25N01JW lab platform. Power policy: 3.3 V only; power off before rewiring.

## 4. What you will build

The physical circuit in [projects/ssd_lab](../../projects/ssd_lab/README.md).
...
[projects/ssd_lab](../../projects/ssd_lab/README.md)

## 11. Success condition

complete read-only bring-up before destructive authorization. Save evidence using the linked project template.

## 12. Next lesson

[Storage Controller](20-storage-controller.md)
