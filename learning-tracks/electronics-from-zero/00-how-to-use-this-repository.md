...
This lesson solves how to **turn a question into a measured physical result**.
...
board, breadboard, DMM and notebook. Power policy: 3.3 V only; power off before rewiring.
...
record FACT, EXPECTED, MEASURED and UNKNOWN separately. Save evidence using the linked project template.

## 12. Next lesson

[Electricity You Can Measure](01-electricity-you-can-measure.md)
