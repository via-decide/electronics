...
This lesson solves how to **control load current without sourcing it from a GPIO**.
...
AO3400A adapter, LED load and gate resistors. Power policy: 3.3 V only; power off before rewiring.

## 4. What you will build

The physical circuit in [Project 04](../../projects/breadboard/04-mosfet-load-switch/PROJECT.md).
...
[Project 04](../../projects/breadboard/04-mosfet-load-switch/PROJECT.md)

## 11. Success condition

identify gate, drain and source from authoritative pin data. Save evidence using the linked project template.

## 12. Next lesson

[Voltage Divider and ADC](06-voltage-divider-and-adc.md)
