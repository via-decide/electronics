...
This lesson solves how to **move a proven circuit from jumpers to controlled geometry**.
...
schematic, ERC, layout, DRC and test points. Power policy: 3.3 V only; power off before rewiring.

## 4. What you will build

The physical circuit in [Sovereign Cartridge carrier](../../projects/ssd_lab/README.md).
...
[Sovereign Cartridge carrier](../../projects/ssd_lab/README.md)

## 11. Success condition

preserve every validated pin and safety constraint. Save evidence using the linked project template.

## 12. Next lesson

[Raw NAND](19-raw-nand.md)
