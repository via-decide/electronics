...
This lesson solves how to **bound current through a nonlinear component**.
...
red LED and 220 ohm, 1 kohm, 10 kohm resistors. Power policy: 3.3 V only; power off before rewiring.

## 4. What you will build

The physical circuit in [Project 02](../../projects/breadboard/02-led-current/PROJECT.md).
...
[Project 02](../../projects/breadboard/02-led-current/PROJECT.md)

## 11. Success condition

calculate current from measured resistor voltage. Save evidence using the linked project template.

## 12. Next lesson

[Button and Pull Resistor](04-button-and-pull-resistor.md)
