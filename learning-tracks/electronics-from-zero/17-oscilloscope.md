...
This lesson solves how to **observe analog shape instead of inferred digital state**.
...
bandwidth-limited probe and scope. Power policy: 3.3 V only; power off before rewiring.

## 4. What you will build

The physical circuit in [future lab extension](../../projects/ssd_lab/README.md).
...
[future lab extension](../../projects/ssd_lab/README.md)

## 11. Success condition

state probe grounding, bandwidth and uncertainty. Save evidence using the linked project template.

## 12. Next lesson

[Custom PCB](18-custom-pcb.md)
