...
This lesson solves how to **turn protocol timing into reviewable evidence**.
...
documented 3.3 V logic analyzer. Power policy: 3.3 V only; power off before rewiring.

## 4. What you will build

The physical circuit in [Projects 06-10](../../projects/ssd_lab/README.md).
...
[Projects 06-10](../../projects/ssd_lab/README.md)

## 11. Success condition

save real captures only, with probe map and sample settings. Save evidence using the linked project template.

## 12. Next lesson

[Oscilloscope](17-oscilloscope.md)
