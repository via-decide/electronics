# Breadboard Without Confusion

## 1. Physical problem this lesson solves

This lesson solves how to **discover hidden connections and split rails**.
...
breadboard, DMM and jumpers. Power policy: 3.3 V only; power off before rewiring.
...
draw a rail map supported by continuity tests. Save evidence using the linked project template.

## 12. Next lesson

[LED and Resistor](03-led-and-resistor.md)
