...
ESP32 board and audio/input fixture.

## Test Method

Run quantized 8-bit wake-word model and record RAM, flash, and inference latency.

## Pass Metric

Inference fits declared memory and latency budget.
