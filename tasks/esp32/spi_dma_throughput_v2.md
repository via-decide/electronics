...
SPI peripheral, display, or loopback fixture.

## Test Method

Measure VSPI/HSPI DMA throughput and CPU utilization during async full-duplex transfer.

## Pass Metric

DMA transfer meets throughput target without CPU monopolization.
