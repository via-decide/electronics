...
`[firmware/esp32/task_topology.c]`

## Required Hardware

ESP32 board with Wi-Fi workload.

## Test Method

Inspect task priorities/core ownership and stress Wi-Fi while acquisition remains bounded.

## Pass Metric

Acquisition queue does not overflow and watchdog remains healthy during network reconnect.
