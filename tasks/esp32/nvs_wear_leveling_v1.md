...
ESP32 board or NVS test partition.

## Test Method

Validate schema, CRC, commit behavior, and bounded write policy for configuration blobs.

## Pass Metric

Corrupt blobs are rejected and valid configuration survives reboot without repeated writes.
