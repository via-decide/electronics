...
ESP32 MCPWM pins, inverter stage or isolated test fixture, oscilloscope.

## Test Method

Generate SVPWM with MCPWM dead-time and validate phase outputs before motor connection.

## Pass Metric

Dead time is enforced and invalid shoot-through states are absent.
