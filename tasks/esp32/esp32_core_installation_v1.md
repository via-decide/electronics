...
ESP32 development board, USB data cable, host with ESP-IDF and optional Arduino IDE.

## Test Method

Toolchain smoke check; verify ESP-IDF project metadata and baseline flash procedure.

## Pass Metric

Clean clone can run repository validation and example build instructions are present.
