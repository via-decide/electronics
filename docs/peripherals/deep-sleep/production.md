# Deep Sleep production

## Purpose

This page records Deep Sleep engineering knowledge for production firmware and hardware validation. It must be kept traceable to source code, examples, benchmarks, reports, and primary references.
...
- Link the driver, example, task, validation procedure, benchmark record, and production-risk entry that implement this Deep Sleep policy.
