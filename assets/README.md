...
| Directory | Content |
| --- | --- |
| `images/` | Rendered figures and supporting graphics. |
| `oscilloscope/` | Voltage, current, analog, reset, and timing captures. |
| `logic-analyzer/` | Protocol traces and digital timing captures. |
| `logic_analyzer/` | Compatibility path for logic-analyzer traces using underscore naming. |
| `thermal/` | Thermal-camera captures and temperature measurement records. |
| `pcb/` | PCB screenshots, fabrication notes, and assembly evidence. |
