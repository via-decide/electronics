...
- Meter evidence: `10-spi-nor-mini-storage-meter-reading-YYYYMMDD.jpg`.
- Bus evidence when the project has a digital bus: `10-spi-nor-mini-storage-logic-YYYYMMDD.png`.
