...
- Meter evidence: `04-mosfet-load-switch-meter-reading-YYYYMMDD.jpg`.
- Bus evidence when the project has a digital bus: `04-mosfet-load-switch-logic-YYYYMMDD.png`.
